...
if [! -e "$1/META/MRDEF.pipe"]
then
current =$(pwd)
cd "$1/META"
echo "-> Converting RRF files for SQLite"
for f in MRCONSO.RRF MRHIER.RRF MRRANK.RRF MRREL.RRF SRDEF SRSTR SRSTRE1 SRSTRE2 MRSAB.RRF MRSTY.RRF MRSAT.RRF
do
