...
path_to_mrhier = "../UMLS/subset/2021AB/META/MRHIER.RRF"
####################################################################
...
def read_transform_mrhier(path_to_mrhier: str):
    ...
    """
    mrhier_rrf = pd.read_csv(path_to_mrhier,
                             sep='|',
                             header=None,
                             dtype=object)
...
def explode_write_mrhier(root: str, home: str, mrhier: pd.DataFrame):
    ...
    child_of_rel_ptr = hier_df[
        hier_df[':START_ID'] != hier_df[':END_ID']
